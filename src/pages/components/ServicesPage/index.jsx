  ...
  return (
    <div className="bg-gray-200 shadow-md rounded-lg p-4 flex flex-col items-center transition-transform duration-300 hover:scale-105">
     {/* <div className="bg-gray-800 shadow-md rounded-lg p-4 flex flex-col items-center transition-transform duration-300 hover:scale-105"> */}
      ...
      />
      <h3 className="text-xl font-bold mb-2 text-pink-600">{title}</h3>
      <p className="text-md text-center px-4">{description}</p>
    </div>
  );
};
  ...
  return (
    <div className="flex flex-col min-h-screen ml-80">
      ...
      <div className="flex-grow flex flex-col justify-center items-center py-16">
        <h1 className="text-4xl font-serif text-gray-800 mb-6">Our Services</h1>
