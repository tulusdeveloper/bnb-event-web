...
const AboutPage = () => {
  return (
    <div className="flex flex-col min-h-screen ml-80">
      <Header />
      <div className="flex-grow flex flex-col items-center justify-center dark:text-white dark:bg-gray-900">
        <div className="max-w-5xl px-6 py-12">
          <h1 className="text-5xl font-serif text-gray-800 dark:text-white mb-8 text-center">About Us</h1>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center mb-12">
            ...
            <div className="md:w-1/2 md:pl-8">
              <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-4">Bliss & Blooms</h2>
